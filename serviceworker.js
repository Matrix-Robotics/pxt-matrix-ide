...
function initWebappServiceWorker() {
    ...
    const webappUrls = [
        ...
        `@simUrl@`,
        // webapp files
        `/pxt-matrix-ide/semantic.js`,
        `/pxt-matrix-ide/main.js`,
        `/pxt-matrix-ide/pxtapp.js`,
        `/pxt-matrix-ide/typescript.js`,
        `/pxt-matrix-ide/marked/marked.min.js`,
        `/pxt-matrix-ide/highlight.js/highlight.pack.js`,
        `/pxt-matrix-ide/jquery.js`,
        `/pxt-matrix-ide/pxtlib.js`,
        `/pxt-matrix-ide/pxtcompiler.js`,
        `/pxt-matrix-ide/pxtpy.js`,
        `/pxt-matrix-ide/pxtblockly.js`,
        `/pxt-matrix-ide/pxtwinrt.js`,
        `/pxt-matrix-ide/pxteditor.js`,
        `/pxt-matrix-ide/pxtsim.js`,
        `/pxt-matrix-ide/pxtembed.js`,
        `/pxt-matrix-ide/pxtworker.js`,
        `/pxt-matrix-ide/pxtweb.js`,
        `/pxt-matrix-ide/blockly.css`,
        `/pxt-matrix-ide/semantic.css`,
        `/pxt-matrix-ide/rtlsemantic.css`,
        // blockly
        `/pxt-matrix-ide/blockly/media/sprites.png`,
        `/pxt-matrix-ide/blockly/media/click.mp3`,
        `/pxt-matrix-ide/blockly/media/disconnect.wav`,
        `/pxt-matrix-ide/blockly/media/delete.mp3`,
        // monaco; keep in sync with webapp/public/index.html
        `/pxt-matrix-ide/vs/loader.js`,
        `/pxt-matrix-ide/vs/base/worker/workerMain.js`,
        `/pxt-matrix-ide/vs/basic-languages/bat/bat.js`,
        `/pxt-matrix-ide/vs/basic-languages/cpp/cpp.js`,
        `/pxt-matrix-ide/vs/basic-languages/python/python.js`,
        `/pxt-matrix-ide/vs/basic-languages/markdown/markdown.js`,
        `/pxt-matrix-ide/vs/editor/editor.main.css`,
        `/pxt-matrix-ide/vs/editor/editor.main.js`,
        `/pxt-matrix-ide/vs/editor/editor.main.nls.js`,
        `/pxt-matrix-ide/vs/language/json/jsonMode.js`,
        `/pxt-matrix-ide/vs/language/json/jsonWorker.js`,
        // charts
        `/pxt-matrix-ide/smoothie/smoothie_compressed.js`,
        `/pxt-matrix-ide/images/Bars_black.gif`,
        // gifjs
        `/pxt-matrix-ide/gifjs/gif.js`,
        // ai
        `/pxt-matrix-ide/ai.0.js`,
        // target
        `/pxt-matrix-ide/target.js`,
        // These macros should be replaced by the backend
        ``,
        ``,
        ``,
        `@targetUrl@/pxt-matrix-ide/monacoworker.js`,
        `@targetUrl@/pxt-matrix-ide/worker.js`
    ];
    // Replaced by the backend by a list of encoded urls separated by semicolons
    const cachedHexFiles = decodeURLs(``);
    const cachedTargetImages = decodeURLs(`%2Fpxt-matrix-ide%2Fdocs%2Fstatic%2Flogo.svg;%2Fpxt-matrix-ide%2Fdocs%2Fstatic%2Flogo.svg;%2Fpxt-matrix-ide%2Fdocs%2Fstatic%2Flogo.svg;%2Fpxt-matrix-ide%2Fdocs%2Fstatic%2Flogo.svg;%2Fpxt-matrix-ide%2Fdocs%2Fstatic%2Fmatrix-logo-white.png;%2Fpxt-matrix-ide%2Fdocs%2Fstatic%2Fhero.jpg`);
